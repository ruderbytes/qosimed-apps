package com.pondokprogrammer.qosim.classes;
...
/**
 * Created by muhammad on 14/04/16.
 */
public class ActivitySlider {
    ...
    public ActivitySlider(FragmentActivity activity) {
        ...
        this.menuContainer.setId(R.id.FrameContainer);
    ...
    public void showMenu(int dpWidth) {
        ...
        final int menuWidth = dpToPixel(this.activity, dpWidth);
